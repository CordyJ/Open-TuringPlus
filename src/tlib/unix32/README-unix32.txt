This directory contains the machine dependent files for 32-bit Unix-like systems.  
...
To make 32-bit version of the Turing+ compiler on these systems, run the command
